...
// };
  ...
  return (
    <div className="mb-20">
      {errorPopular || errorTrending || errorTopMovies || errorLatestMovies ? (
        ...
        <Loading />
      ) : dataPopular && dataTrending && dataTopMovies && dataLatestMovies ? (
        <>
          {/* Movie Banner */}
          <Swiper
            slidesPerView={1}
          ...
          {/* <div className="container">
            ...
            <div className='relative flex items-center group'>
                ...
                />
                <div id={"slider"} className='w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative'>
                    {dataTopMovies.results.slice(0, 10).map((item, index) => (
                        <div className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2' key={item.id}>
          ...
          {/* Latest Movies */}
          {/* <div className="container">
            <p className="text-xl font-bold mt-16 my-4">⭐ Latest Movies</p>
            <div className='relative flex items-center group'>
                <MdChevronLeft 
                    onClick={slideLeft}
                    className="bg-white left-0 rounded-full absolute opacity-50 hover:opacity-100 cursor-pointer z-10 group-hover:block"
                ...
                />
                <div id={"slider"} className='w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative'>
                    {dataLatestMovies.results.map((item) => (
                        <div className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2' key={item.id}>
                            <MovieCard key={item.id} item={item}  />
                        </div>
                    ))}
